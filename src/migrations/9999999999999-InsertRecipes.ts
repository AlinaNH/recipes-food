...
export class InsertRecipes9999999999999 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    (164,	'Skillet Chicken Puttanesca',	'https://healthyfitnessmeals.com/wp-content/uploads/2020/12/CHICKEN-PUTTANESCA-9.jpg',	4,	40,	'https://www.simplyrecipes.com/recipes/skillet_chicken_puttanesca/',	'Pour the tomatoes into a bowl and crush with your hands or with a wooden spoon until you have uneven 1-inch pieces (you can also use scissors to snip the tomatoes into small pieces).
