...
export class CreateDatabase1610889925636 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "ingredients" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "productId" integer, "unitId" integer, CONSTRAINT "PK_9240185c8a5507251c9f15e0649" PRIMARY KEY ("id"))`);
